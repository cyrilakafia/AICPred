def faqs():
    faqs_list = [
        ...
        {'question': 'How accurate are the predictions made by StormPred?', 'answer': 'The XGBoost and Decision Tree models were able to predict all experimentally validated inhibitors of TLR4 as active with a confidence range of 0.83-1.00. This makes StormPred reliable.'},
